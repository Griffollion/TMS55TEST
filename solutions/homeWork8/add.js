...
//     card.innerHTML += `<img src = "${(element.foto)}">`
//     card.innerHTML += `<p>${(element.mark)}</p>`
//     card.innerHTML += `<p>${(element.model)}</p>`
//     card.innerHTML += `<p>${(element.year)}</p>`
//     card.innerHTML += `<p>${(element.engine)}</p>`
//     card.innerHTML += `<p>${(element.fuel)}</p>`
...
const cheapAuto = auto.filter(ele => ele.price < 4000)
const middleAuto = auto.filter(ele => ele.price > 3000 && ele.price < 10000)
const expensiveAuto = auto.filter(ele => ele.price > 10000)
